...
public class ColorPickerPopup {
    ...
    public void show(View parent, final ColorPickerObserver observer) {
        ...
        View layout = inflater.inflate(top.defaults.colorpicker.R.layout.top_defaults_view_color_picker_popup, null);
        final ColorPickerView colorPickerView = layout.findViewById(top.defaults.colorpicker.R.id.colorPickerView);
        ...
        TextView cancel = layout.findViewById(top.defaults.colorpicker.R.id.cancel);
        ...
        TextView ok = layout.findViewById(top.defaults.colorpicker.R.id.ok);
        ok.setText(okTitle);
        ...
        final View colorIndicator = layout.findViewById(top.defaults.colorpicker.R.id.colorIndicator);
        final TextView colorHex = layout.findViewById(top.defaults.colorpicker.R.id.colorHex);
        ...
        popupWindow.setAnimationStyle(top.defaults.colorpicker.R.style.TopDefaultsViewColorPickerPopupAnimation);
