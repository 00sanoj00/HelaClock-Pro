...
public class ColorPickerView extends LinearLayout implements ColorObservable {
    ...
    private top.defaults.colorpickerr.ColorWheelView colorWheelView;
    ...
    public ColorPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, top.defaults.colorpicker.R.styleable.ColorPickerView);
        boolean enableAlpha = typedArray.getBoolean(top.defaults.colorpicker.R.styleable.ColorPickerView_enableAlpha, false);
        boolean enableBrightness = typedArray.getBoolean(top.defaults.colorpicker.R.styleable.ColorPickerView_enableBrightness, true);
        onlyUpdateOnTouchEventUp = typedArray.getBoolean(top.defaults.colorpicker.R.styleable.ColorPickerView_onlyUpdateOnTouchEventUp, false);
        typedArray.recycle();
